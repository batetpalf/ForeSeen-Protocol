...
const rewardModules = [
  {
    ...
    copy: "FORE holders earn better campaign weight across active trading seasons."
  },
  {
  ...
  {
    title: "Tiered status",
    copy: "Higher FORE balances unlock more access, recognition, and premium experiments."
  }
];
      ...
      <div className="shell">
        ...
        <div className="stats-grid">
          <div className="stat-card">
            <span className="eyebrow">FORE balance</span>
