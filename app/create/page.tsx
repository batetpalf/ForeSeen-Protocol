      ...
      <div className="shell narrow-shell">
        <div className="section-heading">
          <div>
            ...
            <h1 className="page-title">Propose a market for review</h1>
          </div>
        </div>

        <div className="content-block">
          <p>
            MVP scope keeps market creation moderated. This page exists to show the product path for permissioned
            market intake before fully open creation.
          </p>
